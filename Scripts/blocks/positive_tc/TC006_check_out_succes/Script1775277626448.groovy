...
WebUI.setText(findTestObject('Object Repository/page_checkout/input__billing_postcode'), '19999')
...
WebUI.waitForElementVisible(findTestObject('Object Repository/page_checkout/txt_Thank you. Your order has been received'), 
    0)

WebUI.verifyElementVisible(findTestObject('Object Repository/page_checkout/txt_Order Details'))
